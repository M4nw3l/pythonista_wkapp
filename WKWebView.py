...
class WKWebView(ui.View):
    ...
    def init_webview(self):
       ...
       webview = WKWebView.WKWebView.alloc().initWithFrame_(((0,0), (0, 0))).autorelease()
       del webview
    ...
    def add_script_message_handler_name(self, name):
      self.user_content_controller.addScriptMessageHandler_name_(self.custom_message_handler, name)
...
if __name__ == '__main__':
  ...
  class MyView(ui.View):
    def __init__(self, *args, **kwargs):
      ...
      print("view init")
      self.webview = MyWebView(name='DemoWKWebView', delegate=self, 
      swipe_navigation=True, data_detectors=(WKWebView.PHONE_NUMBER,WKWebView.LINK), frame=self.bounds, flex='WH')
